        ...
        <div class="col-md-8 col-sm-offset-2">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Features Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              {!! Form::open(['url' => ADMIN_URL.'/add_features', 'class' => 'form-horizontal', 'files' => true]) !!}
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {!! Form::text('link', '', ['class' => 'form-control', 'placeholder' => 'URL for Redirect']) !!}
