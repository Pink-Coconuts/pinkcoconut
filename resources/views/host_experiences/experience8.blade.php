...
<div class="bg_new clearfix text-white">
  ...
  <div class="side_bar pull-left padd4">
    ...
    <ul class="list-unstyled text-uppercase bold side_menu  space-top-7">
      ...
      <li class="active op_lw1"><a href="#" class="rm_link"> What I’ll provide </a></li>
  ...
  <div class="main_bar pull-left padd5 bg-white text-black">
    ...
    <div class="clearfix ">
      <div class="col-md-7">
        ...
        <p class="h2 bold space-top-8">Confirm what you’ll provide</p>
        <p class="h4 line1 space-2">On this page, you can add additional details about what you are providing. For example, you can let your guests know that you accommodate vegetarians.</p>
          ...
          <div class="clone_sec_wrap">
            <div class="clone_sec">
              ...
              <div class="clearfix space-top-8 space-2">
                <p class="bold h4 pull-left space-0">Item one</p>
                <a href="#" class="h6 rm_link pull-right space-0 text-rausch hide mul_rm">remove</a>
              </div>

              <div class="drp_dwn_cng1 pos_rel dropdown2 hide2">
                <i class="icon-chevron-down"></i>
                <select class="" id="itme_pro">
              ...
              <div class="focus_txt">
                <input type="text" class="input_new1 top_1px_adj mul_input hide" name="" placeholder="Name Item" />            
                <textarea class="input_new1 top_1px_adj hide mul_textarea" rows="3" placeholder="Add any additional details (optional)"></textarea>
              </div>
              <p class="text-warning space-top-2 focus_show">1 character needed</p>             

            </div> <!-- close sec end -->

            <a href="#" class="rm_link text-rausch dis_blk hide mul_add hide"><span class="icon-add"></span> <span class="h5">Add another item</span> </a>

          </div><!-- clone_sec_wrap end -->

          </div>
        </div>    

        <button class="btn-primary3 space-top-8 space-8" > <a href="11" class="rm_link"> Save</a></button>&nbsp;&nbsp;
        <button class="btn-primary2 space-top-8 space-8" > <a href="11" class="rm_link"> Undo</a></button>
...
<div class="popup hide1">
 <div class="popup_frame " data-id="popup1">
