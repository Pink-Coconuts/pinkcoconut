...
<div class="bg_new clearfix text-white">
  ...
  <div class="side_bar pull-left padd4">
    ...
    <ul class="list-unstyled text-uppercase bold side_menu  space-top-7">
      ...
      <li class="active op_lw1"><a href="#" class="rm_link"> Tagline </a></li>
  ...
  <div class="main_bar pull-left padd5 bg-white text-black">
    ...
    <div class="clearfix ">
      <div class="col-md-7">
        <p class="h2 bold space-top-8">Write a tagline</p>
        <p class="h4 line1 space-2">Clearly describe your experience in one short, catchy sentence. Start with a verb that tells guests what they will do.</p>
        ...
        <button class="btn-primary3 space-top-8 space-8" > <a href="6" class="rm_link"> Save</a></button>&nbsp;
 ...
 <div class="popup_frame popup_frame " data-id="popup2">
  ...
  <div class="clearfix pos_rel">
    ...
    <div class="col_sm_6 padd4">
      ...
      <p class="h3 space-top-7 space-1 bold">Start with a verb.</p>    
      <p class="h4 space-top-1 space-5 line1">Guests should immediately understand what they’ll do. Start with the main action, then mention who they’ll be with or where they’ll be.</p>
      <p class="h3 space-top-7 space-1 bold">Be brief and clear</p>    
      <p class="h4 space-top-1 space-5 line1">Taglines are just a sentence long. They should be simple and straightforward. Don’t worry about embellishing.</p>
