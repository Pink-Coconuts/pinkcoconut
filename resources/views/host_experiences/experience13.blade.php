...
<div class="bg_new clearfix text-white">
  ...
  <div class="side_bar pull-left padd4">
    ...
    <ul class="list-unstyled text-uppercase bold side_menu  space-top-7">
      ...
      <li class="active op_lw1"><a href="#" class="rm_link"> Group size</a></li>
  ...
  <div class="main_bar pull-left padd5 bg-white text-black">
    ...
    <div class="clearfix ">
      <div class="col-md-7">
        <p class="h2 bold space-top-8">Maximum number of guests</p>
        <p class="h4 line1 space-2">What’s the number of guests you can accommodate?</p>
          ...
          <div class="col-sm-8">
            <div class="drp_dwn_cng1 pos_rel dropdown2 space-top-2">
                ...
                <select class="">
                  ...
                  <option value="Meal">4</option>
                  <option value="Drink">5</option>
                  <option value="Tickets">6</option>
                </select>            
            </div>
          </div>
        </div>
        
        <button class="btn-primary3 space-top-8 space-8" > <a href="16" class="rm_link"> Save</a></button> &nbsp;&nbsp;
        <button class="btn-primary2 space-top-8 space-8" > <a href="16" class="rm_link"> Undo</a></button>
