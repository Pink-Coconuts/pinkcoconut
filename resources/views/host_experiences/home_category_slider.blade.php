...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 home_exprt" >
  <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 " style="padding:0px;     margin: 45px 0px 15px;" ng-if="featured_category.host_experiences.length > 0">
  ...
  <div class="home-bx-slider1 col-md-12 col-lg-12 col-sm-12 col-xs-12 " style="position:relative;padding:0px;">
    <div class="row hm_slide1" >
      <div class="cateimg1" ng-repeat="(key, host_experience) in featured_category.host_experiences" ng-if="key<=7">
        <div class="col-md-3">
        ...
        <div class="panel-body panel-card-section" style="padding:10px 0px;">
          ...
          <div class="media">
            <div class="category_city nt_ctcity">
              ...
              <span class="pull-left">@{{host_experience.city_name}}</span>
          </div>
  ...
  <div class="seeMoreContainer_11b8zgn" ng-if="featured_category.host_experiences.length > 8">
      <a href="{{ url('s?current_refinement=Experiences&host_experience_category=') }}@{{featured_category.host_experiences[0].category}}" >
