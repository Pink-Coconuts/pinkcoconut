...
<div class="bg_new clearfix text-white">
  ...
  <div class="side_bar pull-left padd4">
    ...
    <ul class="list-unstyled text-uppercase bold side_menu  space-top-7">
      ...
      <li class="active op_lw1"><a href="#" class="rm_link"> Packing list</a></li>
  ...
  <div class="main_bar pull-left padd5 bg-white text-black">
    ...
    <div class="clearfix ">
      <div class="col-md-7">
        <p class="h2 bold space-top-8">Create a packing list</p>
        <p class="h4 line1 space-2">Let your guests know what to bring so they’re prepared.</p>

        <p class="h4 bold space-top-5">Arts and Design</p>
        <p class="h4 space-4">What should your guests bring?</p>

        <div class="clone_elem pos_rel hide">
          <span class="icon icon2-cancel cursor clone_close"></span>
          <input type="text" class="input_new1 space-1" name="" placeholder="Enter item here">
        </div>

        <a href="#" class="rm_link text-rausch h4 clone_trg dis_blk space-top-3"> + Add an item</a>

        <a href="20" class="rm_link"><button class="btn-primary2 space-top-8 space-8" > Next</button></a>
      </div>
