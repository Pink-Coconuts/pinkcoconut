...
<div class="bg_new clearfix text-white">
  ...
  <div class="side_bar pull-left padd4">
    ...
    <ul class="list-unstyled text-uppercase bold side_menu  space-top-7">
      ...
      <li class="active op_lw1"><a href="#" class="rm_link"> What we’ll do </a></li>
  ...
  <div class="main_bar pull-left padd5 bg-white text-black">
    ...
    <div class="clearfix ">
      <div class="col-md-7">
        <p class="h2 bold space-top-8">Mention what you’ll do</p>
        <p class="h4 line1 space-2">Describe in detail what you’ll be doing with your guests. The more information you can give, the better.</p>
        ...
        <p class="text-warning focus_show space-top-2" >583 characters needed</p>

        <button class="btn-primary2 space-top-8 space-8" > <a href="8" class="rm_link"> Next</a></button>
 ...
 <div class="popup_frame popup_frame " data-id="popup1">
  ...
  <div class="clearfix pos_rel">
    ...
    <div class="col_sm_6 padd4">
      ...
      <p class="h3 space-top-7 space-1 bold">Set expectations</p>    
      <p class="h4 space-top-1 space-3 line1">it’s important guests know what they’re getting into. Let them know if they have to be prepared for any particular adventures.</p>

      <p class="h3 space-top-5 space-1 bold">Be specific</p>    
      <p class="h4 space-top-1 space-3 line1">If you’re experience is technical, like a workshop or tutorial, don’t be afraid to get into the weeds. Guests want to know exactly what they’re paying for.</p>      
    </div>
