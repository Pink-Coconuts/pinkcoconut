...
<div class="bg_new clearfix text-white">
  ...
  <div class="side_bar pull-left padd4">
    ...
    <ul class="list-unstyled text-uppercase bold side_menu  space-top-7">
      <li class="active op_lw1"><a href="#" class="rm_link"> FINISHING TOUCHES</a></li>
  ...
  <div class="main_bar pull-left padd5">
    ...
    <div class="clearfix ">
      <div class="col-md-7">
        <p class="h1 bold space-top-8">Finishing Touches</p>
        <p class="h4 line1 space-2">Just a few more things and you’re ready to submit!</p>
        
        <button class="btn-primary3 space-top-8 space-8" > <a href="13" class="rm_link"> Next</a></button>
      </div>
