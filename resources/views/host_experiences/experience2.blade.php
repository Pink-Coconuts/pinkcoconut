...
<div class="bg_new clearfix text-white">
  ...
  <div class="side_bar pull-left padd4">
    ...
    <ul class="list-unstyled text-uppercase bold side_menu  space-top-7">
      ...
      <li class="active op_lw1"><a href="#" class="rm_link"> Time </a></li>
  ...
  <div class="main_bar pull-left padd5 bg-white text-black">
    ...
    <div class="clearfix ">
      <div class="col-md-7">
        <p class="h2 bold space-top-8">Set your default time</p>
        <p class="h4 line1 space-2">You can adjust this time later depending on the dates you’re scheduled to host. Each experience must be at least 1 hour.</p>
        <br>
       ...
       <div class="row">
        <div class="col-sm-5">
          <div class="drp_dwn_cng1 pos_rel dropdown2">
              ...
              <select class="">
                <option>12:00am EDT</option>
                <option>1:00am EDT</option>
                <option>2:00am EDT</option>
              </select>            
          </div>
        </div>

        <div class="col-sm-1">
          <p class="space-top-3 h4 text-center">to</p>
        </div>
        ...
        <button class="btn-primary3 space-top-8 space-8" > <a href="5" class="rm_link"> Save</a></button>&nbsp;
...
<div class="popup hide">
 <div class="popup_frame popup_frame padd4 popup_frame_sz1">
    <a href="#" class="h4 rm_link close_pop text-muted"><i class="icon icon2-cancel"></i></a>
    <p class="h5 space-top-3 space-3">Are you sure you want to change your submission language? If saved, this will delete your descriptions written in English.</p>
