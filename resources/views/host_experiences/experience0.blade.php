...
<div class="bg_new clearfix text-white">
  ...
  <div class="side_bar pull-left padd4">
    ...
    <ul class="list-unstyled space-top-5 text-uppercase bold side_menu">
      <li class="active op_lw1"><a href="#" class="rm_link"> THE BASICS</a></li>
      <li class="op_lw1"><a href="#" class="rm_link"> Language</a></li>
  ...
  <div class="main_bar pull-left padd5 pos_rel">
    ...
    <div class="clearfix ">
      ...
      <div class="col-md-7">
        <p class="h1 bold space-top-8">Create your experience</p>
        <p class="h4 line1 space-2">You are one of the very first members of a new Airbnb community. We’re excited to see what you create, and we’re even more excited to partner with you to create incredible travel experiences for guests from around the world.</p>
        
        <button class="btn-primary4 space-top-8 space-8" > <a href="0" class="rm_link"> Next</a></button>
      </div>
