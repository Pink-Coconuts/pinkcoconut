...
<div class="bg_new clearfix text-white">
  ...
  <div class="side_bar pull-left padd4">
    ...
    <ul class="list-unstyled text-uppercase bold side_menu  space-top-7">
      ...
      <li class="active op_lw1"><a href="#" class="rm_link"> Photos </a></li>
      <li class="op_lw1"><a href="#" class="rm_link"> About organization </a></li> 
  ...
  <div class="main_bar pull-left padd5 bg-white text-black">
    ...
    <div class="clearfix ">
      <div class="col-md-7">
        <p class="h2 bold space-top-8">Add photos for your experience</p>
        <p class="h4 line1 space-2">Choose photos that showcase the location and what guests will be doing. Photos must be at least 480x720 pixels.</p>
        <a href="#" class="rm_link text-rausch h4 pop_link" data-id="popup2"> <span class="icon icon2-light-bulb h3"></span> Tips and examples</a>
        <br>

        <label class="browse text-center space-top-8 bg_cover pos_rel pop_link" data-id="popup1" style="background-image: url('{{url('images/host_experiences/pro2.jpg')}}');"><a class="icon icon2-cancel close1 rm_link" href="#"></a> <span class="icon-add h4 text-rausch "></span><input type="file" name="" disabled=""></label><br>

        <label class="browse text-center space-top-8"> <span class="icon-add h4 text-rausch "></span><input type="file" name="" ></label><br>

        <label class="browse text-center space-top-8"> <span class="icon-add h4 text-rausch "></span><input type="file" name="" ></label>

        <br>
        <button class="btn-primary2 space-top-8 space-8" > <a href="6_1" class="rm_link"> Next</a></button>
      </div>
...
<div class="popup hide1">
 <div class="popup_frame padd4 popup_frame_sz1" data-id="popup1">
    <a href="#" class="h5 rm_link close_pop text-muted"><i class="icon icon2-cancel"></i></a>
    <p class="h3 space-top-3 space-3 bold">Upload a photo with higher resolution</p>
    <p class="h4 space-top-3 space-4">Photos must be at least 480x720 pixels. Please upload a photo of higher quality. Your photo was 648x307.  </p>
    <a href="#" class="btn-primary3 btn_sm">Choose another photo</a>&nbsp; <a href="#" class="btn-primary2 close_pop btn_sm">Cancel</a>
 </div>
</div>
 ...
 <div class="popup_frame popup_frame " data-id="popup2">
  ...
  <div class="clearfix pos_rel">
    ...
    <div class="col_sm_6 padd4">
      ...
      <p class="h3 space-top-7 space-1 bold">Make it high-resolution</p>    
      <p class="h4 space-top-1 space-3 line1">Try taking photos with a camera that takes high-resolution shots. If not, try your best with your phone.</p>

      <p class="h3 space-top-5 space-1 bold">Capture the action</p>    
      <p class="h4 space-top-1 space-8 line1">Give guests a sense of what they’ll be doing. Take photos of the surroundings so they get a feel for the ambiance.</p>      
    </div>
            ...
            <ul>
                <li>
                  ...
                  <div class="text-center">
                    <img src="{{url('images/host_experiences/slider_pop1.jpg')}}" class="img_style2">
                  </div>
                ...
                <li>
                  <div class="text-center">
                    <img src="{{url('images/host_experiences/slider_pop2.jpg')}}" class="img_style2">
                  </div>
