...
class ReviewsDataTable extends DataTable
{
    ...
    public function ajax()
    {
        ...
        return $this->datatables
           ...
           ->addColumn('pride_inclusion_score', function ($reviews) {
                $score = $reviews->pride_inclusion_score;
                $score = $score =='' ?'-':$score;
                return $score;
            })
            ->make(true);
    ...
    public function query()
    {
        $reviews = Reviews::where('list_type', 'Rooms')->join('rooms', function($join) {
                        ...
                        ->select(['reviews.id as id', 'reservation_id', 'rooms.name as room_name', 'users.first_name as user_from', 'users_to.first_name as user_to', 'review_by', 'comments', 'reviews.created_at as created_at', 'reviews.updated_at as updated_at', 'reviews.pride_comments as pride_inclusion_score']);
    ...
    public function html()
    {
        ...
        ->addColumn(['data' => 'pride_inclusion_score', 'name' => 'pride_inclusion_score', 'title' => 'Pride Inclusion Score'])
